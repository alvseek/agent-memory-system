...
Ask for review of project info and objective. STOP. Present to [USER-NAME] for review. Do NOT write the next section until confirmed to avoid cascading changes when this section need adjustment.
...
Ask for review of analysis section. STOP. Present to [USER-NAME] for review. Do NOT write the next section until confirmed to avoid cascading changes when this section need adjustment.
...
Ask for review of solution section. STOP. Present to [USER-NAME] for review. Do NOT write the next section until confirmed to avoid cascading changes when this section need adjustment.
...
After [USER-NAME] instructs to start implementing, start implementing following the **Execution Protocol for AI** in the newly created Implementation Log file
