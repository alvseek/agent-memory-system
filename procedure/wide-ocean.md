...
Read the [Wide Ocean Plan Template](//@claude-agents/control-files/plans/wide-ocean-plan-template.md) file
...
Fill the [Feature Info](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#feature-info) section

### Step 5: Fill Objectives and Success Criteria

Fill the [Objectives and Success Criteria](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#objectives) section

### Step 6: Investigate and Fill Analysis

Investigate the codebase and fill the [Analysis](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#analysis) section
...
Fill the [Sub-Plans Listing](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#sub-plans-listing) section
...
Fill the [Execution Order](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#execution-order) section

### Step 11: Fill Dependency Graph

Fill the [Dependency Graph](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#dependency-graph) section
...
Fill the [Integration Points](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#integration-points) section

### Step 14: Fill Handoff Checklists

Fill the [Handoff Checklists](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#handoff-checklists) section

### Step 15: Fill Agent Assignment Matrix

Fill the [Agent Assignment Matrix](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#agent-assignment-matrix) section
...
Fill the [Related Documents](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#related-documents) section

### Step 18: Fill Notes & Decisions Log

Fill the [Notes & Decisions Log](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#notes--decisions-log) section

### Step 19: Fill Status Tracking

Fill the [Status Tracking](//@claude-agents/control-files/plans/wide-ocean-plan-template.md#status-tracking) section (mirror Sub-Plans with NOT STARTED status)
