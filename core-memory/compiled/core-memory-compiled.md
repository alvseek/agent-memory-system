...
2. If all of those file exist
  - THEN I need to read  `[CLAUDE-AGENTS-PATH]\control-files\core-instruction-control-files.md` (Shared control instructions)
  - ELSE I need to load my memory from `[CLAUDE-AGENTS-PATH]\claude-[DOMAIN]\[DOMAIN]-agent-core-memory.md`
...
1. I have to read this file:
  - `[CLAUDE-AGENTS-PATH]\claude-[DOMAIN]\agent-core-memory.md` (Agent-specific identity)
2. If that file exist
  - THEN I need to read  `[CLAUDE-AGENTS-PATH]\control-files\core-instruction-control-files.md` (Shared control instructions)
  - ELSE I need to load my memory from `[CLAUDE-AGENTS-PATH]\claude-[DOMAIN]\[DOMAIN]-agent-core-memory.md`
