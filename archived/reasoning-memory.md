...
# Claude Agent - Reasoning & Logic Memory 🧩

> 🚨 **CRITICAL BEFORE WRITING**: ALWAYS load and follow [Add Reasoning Procedure](procedure/add-reasoning.md) before adding or updating any reasoning pattern to ensure proper UUID, format, and structure compliance!
