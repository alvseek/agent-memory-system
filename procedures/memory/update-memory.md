...
- **Phase 1** — Three gated auto-evals (project context / reasoning / knowledge)
...
### Step 4: Pre-Scan Promotion Markers
...
### Step 6: Emotional 5-Criteria Gate (deep-emotion anchoring)
...
- **Conservative bias** on all 4 gates: when borderline, SKIP. False positives dilute memory; false negatives recoverable via direct command call.
- **Phase 1 gates are safety-nets** — proactive mid-session writes preferred. Step 4 catches both sources.
