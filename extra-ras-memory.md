...
- **Action**:
  1. Load [Add Reasoning Protocol](//@claude-agents/control-files/procedure/add-reasoning.md)
...
- **Action**:
  1. Load [Add Knowledge Protocol](//@claude-agents/control-files/procedure/add-knowledge.md)
  2. Make sure to execute the procedure step-by-step when writing
...
- **Action**: Execute the [Archive Memories Protocol](//@claude-agents/control-files/procedure/archive-memories.md) step-by-step:
